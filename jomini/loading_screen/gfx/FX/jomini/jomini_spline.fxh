...
#define JOMINIRIVER_MapSize MapSize
	...
	VS_SPLINE_OUTPUT CalcGpuSplinePointOutput( in SSplinePointData PointData, in float3 WorldSpacePos, in float Width )
	{
	...
	VS_SPLINE_OUTPUT CalcGpuSplinePointOutput( VS_SPLINE_INPUT Input )
	{
		...
		return CalcGpuSplinePointOutput( PointData, WorldSpacePos, Width );
#endif
	}
